...
// Module
exports.push([module.i, "*,\nhtml,\nbody {\n    font-family: monospace, sans-serif;\n    margin: 0;\n    padding: 0;\n    box-sizing: border-box;\n}\n\npre {\n    padding: 20px 40px;\n}\n\n.input {\n    display: block;\n    height: 300px;\n    width: 100%;\n    padding: 20px 24px;\n    font-size: 1rem;\n    font-family: monospace, sans-serif;\n    border: 2px solid #4f6d7a;\n    border-radius: 2px;\n    margin-bottom: 20px;\n}\n\n.controls {\n    width: 100%;\n    margin: 20px 0;\n    padding: 0 14px;\n}\n\n.controls__buttons {\n    display: flex;\n    flex-wrap: wrap;\n    align-items: baseline;\n}\n\n#submit {\n    margin: 0;\n    margin-bottom: 10px;\n    margin-right: 40px;\n    padding: 4px 18px 4px 24px;\n    font-size: 1.25rem;\n    line-height: 1.5;\n    background-color: white;\n    border: 2px solid #db504a;\n    border-radius: 2px;\n    font-family: monospace, sans-serif;\n    cursor: pointer;\n    color: black;\n}\n\n#query-input {\n    margin-bottom: 10px;\n    margin-right: 10px;\n    padding: 4px 24px;\n    border: 2px solid #4f6d7a;\n    font-size: 1.25rem;\n    line-height: 1.5;\n}\n\n#search {\n    margin: 0;\n    margin-bottom: 10px;\n    padding: 4px 18px 4px 24px;\n    font-size: 1.25rem;\n    line-height: 1.5;\n    background-color: white;\n    border: 2px solid #db504a;\n    border-radius: 2px;\n    cursor: pointer;\n    color: black;\n}\n\n#render-root {\n    padding: 20px 14px;\n}\n\n.node {\n    margin: 4px 0;\n    padding-left: 24px;\n    border-left: 1px solid #4f6d7a;\n}\n\n.node > .node {\n    display: none;\n}\n\n.node__text {\n    padding: 4px 2px 4px 24px;\n    border-bottom: 1px solid #4f6d7a;\n    background-color: #bacba9;\n}\n\n.node__title {\n    position: relative;\n    display: flex;\n    align-items: baseline;\n    padding: 4px 2px 4px 24px;\n    background-color: #bacba9;\n    border-bottom: 1px solid #4f6d7a;\n    border-radius: 2px;\n}\n\n.node__title--toggle {\n    cursor: pointer;\n    transform: scale(1);\n    transition: transform 0.2s ease-out;\n}\n\n.node__title--toggle:hover {\n    transform: scale(1.005);\n    transition: transform 0.2s ease-in;\n}\n\n.node__title--toggle:active {\n    transform: scale(0.98);\n    transition: transform 0.1s ease-in;\n}\n\n.node__title--toggle:before {\n    position: absolute;\n    left: 4px;\n    top: 2px;\n    content: '➕';\n}\n\n.node--open > .node {\n    display: block;\n}\n\n.node--open > .node__title:before {\n    content: '➖';\n}\n\n.node--found > .node__title {\n    background-color: rgb(227, 181, 5, 0.4);\n}\n\n.node__name {\n    font-size: 1.25rem;\n    font-weight: bold;\n}\n\n.node__attr {\n    margin-left: 14px;\n}\n\n.node__attr-name {\n    color: #4f6d7a;\n}\n\n.node__attr-name::after {\n    color: black;\n    content: '=';\n}\n\n.node__attr-value {\n    color: #4f6d7a;\n}\n\n.invalid-code {\n    color: #db504a;\n}\n\n#search-error {\n    display: inline-block;\n    margin-left: 14px;\n    color: #db504a;\n    font-size: 1.2rem;\n}\n\n.error-text {\n    display: inline-block;\n    width: 100%;\n    padding: 5px 22px;\n    background-color: rgb(219, 80, 74, 0.2);\n    color: #db504a;\n}\n", ""]);
// Exports
...
/* harmony default export */ __webpack_exports__["default"] = ({
  name: 'class',
  querySymbol: '.',
  isMatch: function isMatch(stringValue, query) {
    var classes = query.split('.');
    return classes.every(function (className) {
      return stringValue.includes(className);
    });
  }
});
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _class__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./class */ "./src/attributes/class.js");
/* harmony import */ var _id__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./id */ "./src/attributes/id.js");


/* harmony default export */ __webpack_exports__["default"] = ({
  "class": _class__WEBPACK_IMPORTED_MODULE_0__["default"],
  id: _id__WEBPACK_IMPORTED_MODULE_1__["default"]
});
...
/* harmony import */ var _search__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./search */ "./src/search/index.js");
...
var renderRoot = document.getElementById('render-root');
var lastMapState = null;
submit.addEventListener('click', function () {
  Object(_parser__WEBPACK_IMPORTED_MODULE_8__["default"])(input.value).then(function (_ref) {
    var tree = _ref.tree,
        map = _ref.map;
    lastMapState = map;
    renderTree(tree);
...
searchButton.addEventListener('click', function () {
  ...
  Object(_search__WEBPACK_IMPORTED_MODULE_9__["default"])(lastMapState, queryInput.value).then(function (_ref2) {
    var tree = _ref2.tree,
        map = _ref2.map;
    lastMapState = map;
    renderTree(tree);
...
function renderError(sourceCode, error) {
  ...
  errorText.innerText = "".concat(error.message);

  if (error.source) {
    var codeBeforeError = sourceCode.substring(0, error.source.startIndex);
    var invalidCode = sourceCode.substring(error.source.startIndex, error.source.endIndex + 1);
    var codeAfterError = sourceCode.substring(error.source.endIndex + 1);
    var invalidCodeWrapper = document.createElement('span');
    ...
    var invalidLineEndIndex = codeAfterError.indexOf('\n');
    var endOfInvalidLine = codeAfterError.substring(0, invalidLineEndIndex);
    var lastPathOfCode = codeAfterError.substring(invalidLineEndIndex);
    codeWrap.append("".concat(endOfInvalidLine, "\n"));
    codeWrap.appendChild(errorText);
    codeWrap.append(lastPathOfCode);
  } else {
    codeWrap.append("".concat(sourceCode, "\n"));
...
function renderNode(node) {
  ...
  var canToggle = Boolean(node.children.length);
  ...
  if (Array.isArray(node.children)) {
    node.children.map(function (childElement) {
...
function renderTree(tree) {
  ...
  if (tree) {
    var treeElement = renderNode(tree);
...
function classNames() {
  ...
  return classes.filter(Boolean).map(function (cssClass) {
...
/*!******************************!*\
  !*** ./src/parser/errors.js ***!
  \******************************/
/*! exports provided: WRONG_OPEN_TAG_SYMBOL, WRONG_CLOSE_TAG_SYMBOL, UNCLOSED_TAG, INVALID_TAG_DECLARATION, WRONG_CLOSE_TAG, WRONG_OPEN_TAG, INVALID_TAG, TOO_MANY_ROOTS, DIV_WRONG_ATTRIBUTE, HTML_WRONG_ATTRIBUTE, HTML_WRONG_NESTING */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "WRONG_OPEN_TAG_SYMBOL", function() { return WRONG_OPEN_TAG_SYMBOL; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "WRONG_CLOSE_TAG_SYMBOL", function() { return WRONG_CLOSE_TAG_SYMBOL; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "UNCLOSED_TAG", function() { return UNCLOSED_TAG; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "INVALID_TAG_DECLARATION", function() { return INVALID_TAG_DECLARATION; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "WRONG_CLOSE_TAG", function() { return WRONG_CLOSE_TAG; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "WRONG_OPEN_TAG", function() { return WRONG_OPEN_TAG; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "INVALID_TAG", function() { return INVALID_TAG; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TOO_MANY_ROOTS", function() { return TOO_MANY_ROOTS; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DIV_WRONG_ATTRIBUTE", function() { return DIV_WRONG_ATTRIBUTE; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "HTML_WRONG_ATTRIBUTE", function() { return HTML_WRONG_ATTRIBUTE; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "HTML_WRONG_NESTING", function() { return HTML_WRONG_NESTING; });
/* harmony import */ var core_js_modules_es_function_name__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/es.function.name */ "./node_modules/core-js/modules/es.function.name.js");
/* harmony import */ var core_js_modules_es_function_name__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_function_name__WEBPACK_IMPORTED_MODULE_0__);

var WRONG_OPEN_TAG_SYMBOL = {
  code: 'WRONG_OPEN_TAG_SYMBOL',
  getMessage: function getMessage() {
    return "\uD83E\uDD74 \u0421\u0438\u043C\u0432\u043E\u043B \u043E\u0442\u043A\u0440\u044B\u0442\u0438\u044F \u0442\u0435\u0433\u0430 \u0441\u043B\u0438\u0448\u043A\u043E\u043C \u0440\u0430\u043D\u043E. \u041F\u0440\u0435\u0434\u044B\u0434\u0443\u0449\u0438\u0439 \u0442\u0435\u0433 \u0435\u0449\u0435 \u043D\u0435 \u0437\u0430\u043A\u0440\u044B\u0442";
  }
};
var WRONG_CLOSE_TAG_SYMBOL = {
  code: 'WRONG_CLOSE_TAG_SYMBOL',
  getMessage: function getMessage() {
    return "\uD83E\uDD74 \u0421\u0438\u043C\u0432\u043E\u043B \u0437\u0430\u043A\u0440\u044B\u0442\u0438\u044F \u0442\u0435\u0433\u0430 \u0441\u043B\u0438\u0448\u043A\u043E\u043C \u0440\u0430\u043D\u043E. \u041D\u0430\u0434\u043E \u0441\u043D\u0430\u0447\u0430\u043B\u0430 \u043E\u0442\u043A\u0440\u044B\u0442\u044C \u0442\u0435\u0433";
  }
};
var UNCLOSED_TAG = {
  code: 'UNCLOSED_TAG',
  getMessage: function getMessage() {
    return "\uD83E\uDD74 \u0417\u0430\u0431\u044B\u043B\u0438 \u0437\u0430\u043A\u0440\u044B\u0442\u044C \u0442\u0435\u0433";
  }
};
var INVALID_TAG_DECLARATION = {
  code: 'INVALID_TAG_DECLARATION',
  getMessage: function getMessage() {
    return "\uD83E\uDD74 \u0442\u0435\u0433\u0438 \u0442\u0430\u043A \u043D\u0435 \u043F\u0438\u0448\u0443\u0442\u0441\u044F";
  }
};
var WRONG_CLOSE_TAG = {
  code: 'WRONG_CLOSE_TAG',
  getMessage: function getMessage(tag) {
    return "\uD83D\uDE31 \u0412\u043E\u0443 \u0432\u043E\u0443... \u0421\u043D\u0430\u0447\u0430\u043B\u0430 \u043D\u0430\u0434\u043E \u043E\u0442\u043A\u0440\u044B\u0442\u044C \u0442\u0435\u0433 \"".concat(tag.name, "\"");
  }
};
var WRONG_OPEN_TAG = {
  code: 'WRONG_OPEN_TAG',
  getMessage: function getMessage(tag) {
    return "\uD83D\uDE2D \u0417\u0430\u0431\u044B\u043B\u0438 \u0437\u0430\u043A\u0440\u044B\u0442\u044C \u0442\u0435\u0433 \"".concat(tag.name, "\"");
  }
};
var INVALID_TAG = {
  code: 'INVALID_TAG',
  getMessage: function getMessage(node) {
    return "\uD83D\uDC7D \u041D\u0435\u0438\u0437\u0432\u0435\u0441\u0442\u043D\u044B\u0439 \u0442\u0435\u0433 \"".concat(node.name, "\"");
  }
};
var TOO_MANY_ROOTS = {
  code: 'TOO_MANY_ROOTS',
  getMessage: function getMessage() {
    return "\uD83C\uDF33 \u0412\u043E\u0437\u043C\u043E\u0436\u0435\u043D \u0442\u043E\u043B\u044C\u043A\u043E \u043E\u0434\u0438\u043D \u043A\u043E\u0440\u0435\u043D\u044C \u0443 \u0434\u0435\u0440\u0435\u0432\u0430";
  }
};
var DIV_WRONG_ATTRIBUTE = {
  code: 'DIV_WRONG_ATTRIBUTE',
  getMessage: function getMessage(attr) {
    return "\uD83D\uDC7D \u041D\u0435\u0438\u0437\u0432\u0435\u0441\u0442\u043D\u044B\u0439 \u0430\u0442\u0442\u0440\u0438\u0431\u0443\u0442 \"".concat(attr.name, "\". \u0423 \u0442\u0435\u0433\u0430 div \u0442\u0430\u043A\u043E\u0433\u043E \u043D\u0435 \u0431\u044B\u0432\u0430\u0435\u0442");
  }
};
var HTML_WRONG_ATTRIBUTE = {
  code: 'DIV_WRONG_ATTRIBUTE',
  getMessage: function getMessage(attr) {
    return "\uD83D\uDC7D \u041D\u0435\u0438\u0437\u0432\u0435\u0441\u0442\u043D\u044B\u0439 \u0430\u0442\u0442\u0440\u0438\u0431\u0443\u0442 \"".concat(attr.name, "\". \u0423 \u0442\u0435\u0433\u0430 html \u0442\u0430\u043A\u043E\u0433\u043E \u043D\u0435 \u0431\u044B\u0432\u0430\u0435\u0442");
  }
};
var HTML_WRONG_NESTING = {
  code: 'DIV_WRONG_NESTING',
  getMessage: function getMessage() {
    return "\uD83D\uDC68\uD83C\uDFFE\u200D\uD83E\uDDB3 \u0422\u0435\u0433 html \u043C\u043E\u0436\u0435\u0442 \u0431\u044B\u0442\u044C \u0442\u043E\u043B\u044C\u043A\u043E \u0440\u043E\u0434\u0438\u0442\u0435\u043B\u0435\u043C";
  }
};
...
/* harmony import */ var _parse__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./parse */ "./src/parser/parse.js");
/* harmony import */ var _validator__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./validator */ "./src/parser/validator.js");
/* harmony import */ var _tags__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./tags */ "./src/parser/tags/index.js");
...
var tagsToCheck = [_tags__WEBPACK_IMPORTED_MODULE_5__["default"].html, _tags__WEBPACK_IMPORTED_MODULE_5__["default"].div];

function parseHTML(htmlString) {
  return new Promise(function (resolve, reject) {
    try {
      var _parse = Object(_parse__WEBPACK_IMPORTED_MODULE_3__["default"])(htmlString),
          tree = _parse.tree,
          map = _parse.map;

      Object(_validator__WEBPACK_IMPORTED_MODULE_4__["default"])(tree, map, tagsToCheck);
      resolve({
        tree: tree,
        map: map
      });
...
/*!*****************************!*\
  !*** ./src/parser/parse.js ***!
  \*****************************/
/*! exports provided: getAttributesInfo, getTagInfo, getTags, getNodesMap, getNodesTree, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getNodesMap", function() { return getNodesMap; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getNodesTree", function() { return getNodesTree; });
...
/* harmony import */ var _errors__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ./errors */ "./src/parser/errors.js");
...
function getAttributesInfo(attributesString) {
  // TODO: добавить булевые аттрибуты
  // TODO: Добавить валидацию
  var matches;
  var attributes = [];
  var singleQuoteAttributeRegexp = /([\w-]+?)='([^'"<>]+?)'/gi;
  ...
  var doubleQuoteAttributeRegexp = /([\w-]+?)="([^'"<>]+?)"/gi;
...
function getTagInfo(tagString, startIndex, endIndex) {
  var trimmedTagString = tagString.trim();
  var isCloseTag = /^\/.*$/.test(trimmedTagString); // </div>

  var isSelfClosed = /^.*\/$/.test(trimmedTagString); // <div/>
  ...
  var tagNameRegexp = /^\/?([^\s/]+).*?\/?$/gi;
  var tagNameMatch = tagNameRegexp.exec(trimmedTagString);
  var tagName = tagNameMatch ? tagNameMatch[1] : ''; // </div/>

  if (isCloseTag && isSelfClosed && tagName) {
    var error = new Error(_errors__WEBPACK_IMPORTED_MODULE_23__["INVALID_TAG_DECLARATION"].getMessage());
    error.code = _errors__WEBPACK_IMPORTED_MODULE_23__["INVALID_TAG_DECLARATION"].code;
    error.source = {
  ...
  var attributesString = trimmedTagString.replace(/^\/?([^\s/]+)/i, '').replace(/\/$/i, '');
  return {
    role: role,
    type: 'tag',
    name: tagName,
...
function getTags() {
  ...
  for (var i = 0; i < inputValue.length; i++) {
    if (inputValue[i] === '<') {
      if (currentTagStart !== null) {
        ...
        var error = new Error(_errors__WEBPACK_IMPORTED_MODULE_23__["WRONG_OPEN_TAG_SYMBOL"].getMessage());
        error.code = _errors__WEBPACK_IMPORTED_MODULE_23__["WRONG_OPEN_TAG_SYMBOL"].code;
        error.source = {
          startIndex: i,
          endIndex: i
        };
    ...
    if (inputValue[i] === '>') {
      if (currentTagStart === null) {
        ...
        var _error = new Error(_errors__WEBPACK_IMPORTED_MODULE_23__["WRONG_CLOSE_TAG_SYMBOL"].getMessage());

        _error.code = _errors__WEBPACK_IMPORTED_MODULE_23__["WRONG_CLOSE_TAG_SYMBOL"].code;
        _error.source = {
          startIndex: i,
          endIndex: i
        };
    ...
    currentText = "".concat(currentText).concat(inputValue[i]);
  ...
  if (currentTagStart !== null) {
    var _error2 = new Error(_errors__WEBPACK_IMPORTED_MODULE_23__["UNCLOSED_TAG"].getMessage());

    _error2.code = _errors__WEBPACK_IMPORTED_MODULE_23__["UNCLOSED_TAG"].code;
    _error2.source = {
      startIndex: currentTagStart,
      endIndex: currentTagStart
    };
    throw _error2;
  }
...
function getPreparedTags(sourceTags) {
  return sourceTags.map(function (tag, index) {
...
function getNodesMap(sourceTags) {
  var tags = getPreparedTags(sourceTags);
  var tagsMap = {}; // делаем простой словарик, чтобы легко получать элемент
  ...
  for (var index = 0; index < tags.length; index++) {
    ...
    var lastOpenTag = currentOpenTags[currentOpenTags.length - 1];
    ...
    if (currentTag.role === 'close') {
      if (!lastOpenTag || lastOpenTag.name !== currentTag.name) {
        var error = new Error(_errors__WEBPACK_IMPORTED_MODULE_23__["WRONG_CLOSE_TAG"].getMessage(currentTag));
        error.code = _errors__WEBPACK_IMPORTED_MODULE_23__["WRONG_CLOSE_TAG"].code;
        error.source = currentTag.source;
        throw error;
      }

      currentOpenTags.pop(); // prevOpenTag
    }
  }

  if (currentOpenTags.length) {
    var notClosedTag = currentOpenTags[currentOpenTags.length - 1];

    var _error3 = new Error(_errors__WEBPACK_IMPORTED_MODULE_23__["WRONG_OPEN_TAG"].getMessage(notClosedTag));

    _error3.code = _errors__WEBPACK_IMPORTED_MODULE_23__["WRONG_OPEN_TAG"].code;
    _error3.source = notClosedTag.source;
    throw _error3;
  }

  return tagsMap;
}
function getNodesTree(map) {
  return Object.values(map).find(function (node) {
    return !node.parentId;
  });
} // возвращает готовую AST

function parse(sourceString) {
  var tags = getTags(sourceString);
  var map = getNodesMap(tags);
  var tree = getNodesTree(map);
  return {
    tree: tree,
    map: map // для простого поиска
...
/* harmony import */ var core_js_modules_es_string_includes__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! core-js/modules/es.string.includes */ "./node_modules/core-js/modules/es.string.includes.js");
/* harmony import */ var core_js_modules_es_string_includes__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_string_includes__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _errors__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../errors */ "./src/parser/errors.js");
/* harmony import */ var _attributes__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../attributes */ "./src/attributes/index.js");
...
var allowedAttributes = [_attributes__WEBPACK_IMPORTED_MODULE_5__["default"]["class"].name, _attributes__WEBPACK_IMPORTED_MODULE_5__["default"].id.name];
/* harmony default export */ __webpack_exports__["default"] = ({
  name: 'div',
  visitor: function visitor(node) {
    var invalidAttribute = node.attributes.find(function (attr) {
      return !allowedAttributes.includes(attr.name);
    });

    if (invalidAttribute) {
      var error = new Error(_errors__WEBPACK_IMPORTED_MODULE_4__["DIV_WRONG_ATTRIBUTE"].getMessage(invalidAttribute));
      error.code = _errors__WEBPACK_IMPORTED_MODULE_4__["DIV_WRONG_ATTRIBUTE"].code;
...
/* harmony import */ var core_js_modules_es_function_name__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! core-js/modules/es.function.name */ "./node_modules/core-js/modules/es.function.name.js");
/* harmony import */ var core_js_modules_es_function_name__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_function_name__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _errors__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../errors */ "./src/parser/errors.js");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  visitor: function visitor(node) {
    ...
    if (invalidAttribute) {
      var error = new Error(_errors__WEBPACK_IMPORTED_MODULE_3__["HTML_WRONG_ATTRIBUTE"].getMessage(invalidAttribute));
      error.code = _errors__WEBPACK_IMPORTED_MODULE_3__["HTML_WRONG_ATTRIBUTE"].code;
      error.source = node.source; // TODO: Добавить более точную подсветку для ошибки
    ...
    if (node.parentId !== null) {
      var _error = new Error(_errors__WEBPACK_IMPORTED_MODULE_3__["HTML_WRONG_NESTING"].getMessage());

      _error.code = _errors__WEBPACK_IMPORTED_MODULE_3__["HTML_WRONG_NESTING"].code;
      _error.source = node.source;
      throw _error;
    }
  }
});
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./html */ "./src/parser/tags/html.js");
/* harmony import */ var _div__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./div */ "./src/parser/tags/div.js");


/* harmony default export */ __webpack_exports__["default"] = ({
  html: _html__WEBPACK_IMPORTED_MODULE_0__["default"],
...
/* harmony import */ var _errors__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./errors */ "./src/parser/errors.js");
...
function validate(tree, map, tags) {
  var nodesArray = Object.values(map);
  var validTagsNames = tags.map(function (tag) {
    return tag.name;
  });
  var invalidNode = nodesArray.find(function (node) {
    return node.type === 'tag' && !validTagsNames.includes(node.name);
  });

  if (invalidNode) {
    var error = new Error(_errors__WEBPACK_IMPORTED_MODULE_14__["INVALID_TAG"].getMessage(invalidNode));
    error.code = _errors__WEBPACK_IMPORTED_MODULE_14__["INVALID_TAG"].code;
    error.source = invalidNode.source;
    throw error;
  }

  var roots = nodesArray.filter(function (node) {
    return node.parentId === null;
  });

  if (roots.length > 1) {
    var _error = new Error(_errors__WEBPACK_IMPORTED_MODULE_14__["TOO_MANY_ROOTS"].getMessage());

    _error.code = _errors__WEBPACK_IMPORTED_MODULE_14__["TOO_MANY_ROOTS"].code;
    _error.source = roots[0].source;
    throw _error;
  }
  ...
  try {
    for (var _iterator2 = tags[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
      ...
      var foundNodes = getNodesByName(nodesArray, tagName);
...
/***/ "./src/search/combinators.js":
/*!***********************************!*\
  !*** ./src/search/combinators.js ***!
  \***********************************/
/*! exports provided: combinatorsCodes, getMatchedNode, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "combinatorsCodes", function() { return combinatorsCodes; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getMatchedNode", function() { return getMatchedNode; });
/* harmony import */ var core_js_modules_es_symbol__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/es.symbol */ "./node_modules/core-js/modules/es.symbol.js");
/* harmony import */ var core_js_modules_es_symbol__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_symbol__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var core_js_modules_es_symbol_description__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! core-js/modules/es.symbol.description */ "./node_modules/core-js/modules/es.symbol.description.js");
/* harmony import */ var core_js_modules_es_symbol_description__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_symbol_description__WEBPACK_IMPORTED_MODULE_1__);
...
/* harmony import */ var _attributes__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ../attributes */ "./src/attributes/index.js");
/* harmony import */ var _errors__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ./errors */ "./src/search/errors.js");
...
function getMatchedNode(node, map, selector) {
  var match = combinators[selector.type].match;

  if (typeof match !== 'function') {
    var error = new Error(_errors__WEBPACK_IMPORTED_MODULE_22__["UNKNOWN_SELECTOR"].getMessage(selector.type));
    error.code = _errors__WEBPACK_IMPORTED_MODULE_22__["UNKNOWN_SELECTOR"].code;
    throw error;
  }

  var matchedNode = match(node, map, selector);
...
function getDeepMatchNode(node, map, selector) {
  var matchedNode = getMatchedNode(node, map, selector);
...
var combinators = {
  CHILD: {
    cutOff: function cutOff(_ref) {
      var sourceSelector = _ref.sourceSelector,
          query = _ref.query;
      var resultSourceSelector = sourceSelector;
      var regexp = new RegExp("^(".concat(whitespace, "+)"));
      var match = regexp.exec(sourceSelector);
      ...
      if (!query.length) {
        var error = new Error(_errors__WEBPACK_IMPORTED_MODULE_22__["INVALID_CHILD_COMBINATOR"].getMessage());
        error.code = _errors__WEBPACK_IMPORTED_MODULE_22__["INVALID_CHILD_COMBINATOR"].code;
        throw error;
      }

      var lastSelector = query[query.length - 1];
      var validParentCombinators = [combinatorsCodes.ID_ATTR, combinatorsCodes.CLASS_ATTR, combinatorsCodes.TAG];

      if (!validParentCombinators.includes(lastSelector.type)) {
        var _error = new Error(_errors__WEBPACK_IMPORTED_MODULE_22__["INVALID_PARENT_FOR_CHILD_COMBINATOR"].getMessage());

        _error.code = _errors__WEBPACK_IMPORTED_MODULE_22__["INVALID_PARENT_FOR_CHILD_COMBINATOR"].code;
        throw _error;
      }

      var newQuery = [].concat(_toConsumableArray(query.slice(0, -1)), [{
        type: combinatorsCodes.CHILD,
        value: lastSelector
      }]);
      return {
        sourceSelector: resultSourceSelector,
        query: newQuery
      };
    },
    match: function match(node, map, selector) {
      return getDeepMatchNode(map[node.parentId], map, selector.value);
    }
  },
  FIRST_CHILD: {
    cutOff: function cutOff(_ref2) {
      var sourceSelector = _ref2.sourceSelector,
          query = _ref2.query;
      var resultSourceSelector = sourceSelector;
      var regexp = new RegExp("^(".concat(whitespace, "*>").concat(whitespace, "*)"));
      var match = regexp.exec(sourceSelector);
      ...
      if (!query.length) {
        var error = new Error(_errors__WEBPACK_IMPORTED_MODULE_22__["INVALID_FIRST_CHILD_COMBINATOR"].getMessage());
        error.code = _errors__WEBPACK_IMPORTED_MODULE_22__["INVALID_FIRST_CHILD_COMBINATOR"].code;
        throw error;
      }
      ...
      if (!validParentCombinators.includes(lastSelector.type)) {
        var _error2 = new Error(_errors__WEBPACK_IMPORTED_MODULE_22__["INVALID_PARENT_FOR_FIRST_CHILD_COMBINATOR"].getMessage());

        _error2.code = _errors__WEBPACK_IMPORTED_MODULE_22__["INVALID_PARENT_FOR_FIRST_CHILD_COMBINATOR"].code;
        throw _error2;
      }

      var newQuery = [].concat(_toConsumableArray(query.slice(0, -1)), [{
        type: combinatorsCodes.FIRST_CHILD,
        value: lastSelector
      }]);
      return {
        sourceSelector: resultSourceSelector,
  ...
  NEXT_NODE: {
    cutOff: function cutOff(_ref3) {
      var sourceSelector = _ref3.sourceSelector,
          query = _ref3.query;
      var resultSourceSelector = sourceSelector;
      var regexp = new RegExp("^(".concat(whitespace, "*\\+").concat(whitespace, "*)"));
      var match = regexp.exec(sourceSelector);
      ...
      if (!query.length) {
        var error = new Error(_errors__WEBPACK_IMPORTED_MODULE_22__["INVALID_NEXT_NODE_COMBINATOR"].getMessage());
        error.code = _errors__WEBPACK_IMPORTED_MODULE_22__["INVALID_NEXT_NODE_COMBINATOR"].code;
        throw error;
      }
      ...
      if (!validParentCombinators.includes(lastSelector.type)) {
        var _error3 = new Error(_errors__WEBPACK_IMPORTED_MODULE_22__["INVALID_PARENT_FOR_NEXT_NODE_COMBINATOR"].getMessage());

        _error3.code = _errors__WEBPACK_IMPORTED_MODULE_22__["INVALID_PARENT_FOR_NEXT_NODE_COMBINATOR"].code;
        throw _error3;
      }

      var newQuery = [].concat(_toConsumableArray(query.slice(0, -1)), [{
        type: combinatorsCodes.NEXT_NODE,
        value: lastSelector
      }]);
      return {
        sourceSelector: resultSourceSelector,
    ...
    match: function match(node, map, selector) {
      ...
      var currentNodeIndex = parentNode.children.findIndex(function (child) {
        return child.id === node.id;
      });
      var rightNodes = parentNode.children.slice(0, currentNodeIndex);
      return rightNodes.find(function (rightNode) {
        return getMatchedNode(rightNode, map, selector.value);
      }) || null;
    }
  },
  ID_ATTR: {
    cutOff: function cutOff(_ref4) {
      var sourceSelector = _ref4.sourceSelector,
          query = _ref4.query;
      var resultSourceSelector = sourceSelector;
      ...
      var targetId = matchedString.substring(1); // remove "#" symbol

      resultSourceSelector = sourceSelector.slice(matchedString.length);
      var newQuery = [].concat(_toConsumableArray(query), [{
        type: combinatorsCodes.ID_ATTR,
        value: targetId
      }]);
      return {
        sourceSelector: resultSourceSelector,
    ...
    match: function match(node, map, selector) {
      var isMatch = node.attributes && node.attributes.find(function (attr) {
        return attr.name === _attributes__WEBPACK_IMPORTED_MODULE_21__["default"].id.name && _attributes__WEBPACK_IMPORTED_MODULE_21__["default"].id.isMatch(attr.value, selector.value);
      });
      return isMatch ? node : null;
    }
  },
  CLASS_ATTR: {
    cutOff: function cutOff(_ref5) {
      var sourceSelector = _ref5.sourceSelector,
          query = _ref5.query;
      var resultSourceSelector = sourceSelector;
      var regexp = new RegExp('^(\\.\\w+)');
      var match = regexp.exec(sourceSelector);
      ...
      var matchedString = match[0];
      var targetClass = matchedString.substring(1); // remove "." symbol

      resultSourceSelector = sourceSelector.slice(matchedString.length);
      var newQuery = [].concat(_toConsumableArray(query), [{
        type: combinatorsCodes.CLASS_ATTR,
        value: targetClass
      }]);
      return {
        sourceSelector: resultSourceSelector,
    ...
    match: function match(node, map, selector) {
      var isMatch = node.attributes && node.attributes.find(function (attr) {
        return attr.name === _attributes__WEBPACK_IMPORTED_MODULE_21__["default"]["class"].name && _attributes__WEBPACK_IMPORTED_MODULE_21__["default"]["class"].isMatch(attr.value, selector.value);
      });
      return isMatch ? node : null;
    }
  },
  TAG: {
    cutOff: function cutOff(_ref6) {
      var sourceSelector = _ref6.sourceSelector,
          query = _ref6.query;
      var resultSourceSelector = sourceSelector;
      var regexp = new RegExp('^(\\w+)');
      var match = regexp.exec(sourceSelector);
    ...
    match: function match(node, map, selector) {
      var isMatch = node.name === selector.value;
      return isMatch ? node : null;
    }
  }
};
/* harmony default export */ __webpack_exports__["default"] = (combinators);

/***/ }),

/***/ "./src/search/create-query.js":
/*!************************************!*\
  !*** ./src/search/create-query.js ***!
  \************************************/
/*! exports provided: default */
...
/* harmony import */ var _combinators__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./combinators */ "./src/search/combinators.js");
/* harmony import */ var _errors__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./errors */ "./src/search/errors.js");
...
var combinationsCutOff = [_combinators__WEBPACK_IMPORTED_MODULE_10__["default"].FIRST_CHILD.cutOff, _combinators__WEBPACK_IMPORTED_MODULE_10__["default"].NEXT_NODE.cutOff, _combinators__WEBPACK_IMPORTED_MODULE_10__["default"].CHILD.cutOff, _combinators__WEBPACK_IMPORTED_MODULE_10__["default"].CLASS_ATTR.cutOff, _combinators__WEBPACK_IMPORTED_MODULE_10__["default"].ID_ATTR.cutOff, _combinators__WEBPACK_IMPORTED_MODULE_10__["default"].TAG.cutOff];
...
function parse() {
  var sourceString = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';
  var preparedSource = prepareQueryString(sourceString);

  if (!preparedSource) {
    var error = new Error(_errors__WEBPACK_IMPORTED_MODULE_11__["EMPTY_SELECTOR"].getMessage());
    error.code = _errors__WEBPACK_IMPORTED_MODULE_11__["EMPTY_SELECTOR"].code;
    throw error;
  }

  var queryStringToParse = preparedSource;
  var query = [];

  while (queryStringToParse) {
    var prevSource = queryStringToParse;
    var _iteratorNormalCompletion = true;
    var _didIteratorError = false;
    var _iteratorError = undefined;

    try {
      for (var _iterator = combinationsCutOff[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
        var cutOff = _step.value;
        var result = cutOff({
          sourceSelector: queryStringToParse,
          query: query
        });
    ...
    if (queryStringToParse === prevSource) {
      var _error = new Error(_errors__WEBPACK_IMPORTED_MODULE_11__["UNKNOWN_SELECTOR"].getMessage(queryStringToParse));

      _error.code = _errors__WEBPACK_IMPORTED_MODULE_11__["UNKNOWN_SELECTOR"].code;
      throw _error;
    }
  }
...
/***/ "./src/search/errors.js":
/*!******************************!*\
  !*** ./src/search/errors.js ***!
  \******************************/
/*! exports provided: UNKNOWN_SELECTOR, EMPTY_SELECTOR, INVALID_CHILD_COMBINATOR, INVALID_PARENT_FOR_CHILD_COMBINATOR, INVALID_FIRST_CHILD_COMBINATOR, INVALID_PARENT_FOR_FIRST_CHILD_COMBINATOR, INVALID_NEXT_NODE_COMBINATOR, INVALID_PARENT_FOR_NEXT_NODE_COMBINATOR */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "UNKNOWN_SELECTOR", function() { return UNKNOWN_SELECTOR; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EMPTY_SELECTOR", function() { return EMPTY_SELECTOR; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "INVALID_CHILD_COMBINATOR", function() { return INVALID_CHILD_COMBINATOR; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "INVALID_PARENT_FOR_CHILD_COMBINATOR", function() { return INVALID_PARENT_FOR_CHILD_COMBINATOR; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "INVALID_FIRST_CHILD_COMBINATOR", function() { return INVALID_FIRST_CHILD_COMBINATOR; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "INVALID_PARENT_FOR_FIRST_CHILD_COMBINATOR", function() { return INVALID_PARENT_FOR_FIRST_CHILD_COMBINATOR; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "INVALID_NEXT_NODE_COMBINATOR", function() { return INVALID_NEXT_NODE_COMBINATOR; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "INVALID_PARENT_FOR_NEXT_NODE_COMBINATOR", function() { return INVALID_PARENT_FOR_NEXT_NODE_COMBINATOR; });
var UNKNOWN_SELECTOR = {
  code: 'UNKNOWN_SELECTOR',
  getMessage: function getMessage(selector) {
    return "\uD83E\uDD2C \u041E\u0448\u0438\u0431\u043E\u0447\u043A\u0430. \u041D\u0435\u0438\u0437\u0432\u0435\u0441\u0442\u043D\u044B\u0439 \u0441\u0435\u043B\u0435\u043A\u0442\u043E\u0440: \"".concat(selector, "\"");
  }
};
var EMPTY_SELECTOR = {
  code: 'EMPTY_SELECTOR',
  getMessage: function getMessage() {
    return '👻 Пустой селектор';
  }
};
var INVALID_CHILD_COMBINATOR = {
  code: 'INVALID_CHILD_COMBINATOR',
  getMessage: function getMessage() {
    return '👻 Перед комбинатором потомка должен быть селектор радителя';
  }
};
var INVALID_PARENT_FOR_CHILD_COMBINATOR = {
  code: 'INVALID_PARENT_FOR_CHILD_COMBINATOR',
  getMessage: function getMessage() {
    return '👻 Перед комбинатором потомка должен быть селектор по id, class или tag. И ничего другого';
  }
};
var INVALID_FIRST_CHILD_COMBINATOR = {
  code: 'INVALID_FIRST_CHILD_COMBINATOR',
  getMessage: function getMessage() {
    return '👻 Перед комбинатором первого потомка ">" должен быть селектор радителя';
  }
};
var INVALID_PARENT_FOR_FIRST_CHILD_COMBINATOR = {
  code: 'INVALID_PARENT_FOR_FIRST_CHILD_COMBINATOR',
  getMessage: function getMessage() {
    return '👻 Перед комбинатором первого потомка ">" должен быть селектор по id, class или tag. И ничего другого';
  }
};
var INVALID_NEXT_NODE_COMBINATOR = {
  code: 'INVALID_NEXT_NODE_COMBINATOR',
  getMessage: function getMessage() {
    return '👻 Перед комбинатором следующего элемента "+" должен быть селектор';
  }
};
var INVALID_PARENT_FOR_NEXT_NODE_COMBINATOR = {
  code: 'INVALID_PARENT_FOR_NEXT_NODE_COMBINATOR',
  getMessage: function getMessage() {
    return '👻 Перед комбинатором следующего элемента "+" должен быть селектор по id, class или tag. И ничего другого';
  }
};

/***/ }),

/***/ "./src/search/get-marked-tree.js":
/*!***************************************!*\
  !*** ./src/search/get-marked-tree.js ***!
  \***************************************/
/*! exports provided: isMatchNodeByQuery, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "isMatchNodeByQuery", function() { return isMatchNodeByQuery; });
/* harmony import */ var core_js_modules_es_symbol__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/es.symbol */ "./node_modules/core-js/modules/es.symbol.js");
/* harmony import */ var core_js_modules_es_symbol__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_symbol__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var core_js_modules_es_symbol_description__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! core-js/modules/es.symbol.description */ "./node_modules/core-js/modules/es.symbol.description.js");
/* harmony import */ var core_js_modules_es_symbol_description__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_symbol_description__WEBPACK_IMPORTED_MODULE_1__);
...
/* harmony import */ var core_js_modules_es_array_some__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! core-js/modules/es.array.some */ "./node_modules/core-js/modules/es.array.some.js");
...
/* harmony import */ var core_js_modules_es_object_values__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! core-js/modules/es.object.values */ "./node_modules/core-js/modules/es.object.values.js");
/* harmony import */ var core_js_modules_es_object_values__WEBPACK_IMPORTED_MODULE_21___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_object_values__WEBPACK_IMPORTED_MODULE_21__);
...
/* harmony import */ var _combinators__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! ./combinators */ "./src/search/combinators.js");
...
function isMatchNodeByQuery(node, map, query) {
  var _query = _toArray(query),
      currentSelector = _query[0],
      tail = _query.slice(1);
  ...
  var matchedNode = Object(_combinators__WEBPACK_IMPORTED_MODULE_26__["getMatchedNode"])(node, map, currentSelector);
...
function getMarkedTree() {
  var map = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
  var sourceQuery = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : [];

  var query = _toConsumableArray(sourceQuery);

  query.reverse(); // Костыль для того чтобы находить только одну ноду по ID
  // TODO: Придумать что-нибудь получше

  var hasIdInQuery = query.some(function (selector) {
    return selector.type === _combinators__WEBPACK_IMPORTED_MODULE_26__["combinatorsCodes"].ID_ATTR;
  });
  var foundSomeNode = false; // Помечаем найденную ноду

  var nodesArray = Object.values(map);
  var resultNodes = nodesArray.map(function (node) {
    if (node.type !== 'tag') {
      return node;
  ...
  var foundNodes = resultNodes.filter(function (node) {
    return node.isFound;
  });
  var _iteratorNormalCompletion = true;
  var _didIteratorError = false;
  ...
  try {
    for (var _iterator = foundNodes[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
      var foundNode = _step.value;

      if (foundNode && foundNode.parentId !== null) {
        var currentNodeToOpen = map[foundNode.parentId];
  ...
  return {
    ...
    tree: resultNodes.find(function (node) {
      return !node.parentId;
    }),
    map: resultNodes.reduce(function (result, node) {
      return _objectSpread({}, result, _defineProperty({}, node.id, node));
    }, {})
  };
}

/* harmony default export */ __webpack_exports__["default"] = (getMarkedTree);
...
/* harmony import */ var core_js_modules_es_promise__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! core-js/modules/es.promise */ "./node_modules/core-js/modules/es.promise.js");
/* harmony import */ var core_js_modules_es_promise__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_promise__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _create_query__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./create-query */ "./src/search/create-query.js");
/* harmony import */ var _get_marked_tree__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./get-marked-tree */ "./src/search/get-marked-tree.js");
...
function search(sourceMap, queryString) {
  return new Promise(function (resolve, reject) {
    try {
      var query = Object(_create_query__WEBPACK_IMPORTED_MODULE_3__["default"])(queryString);

      var _getMarkedTree = Object(_get_marked_tree__WEBPACK_IMPORTED_MODULE_4__["default"])(sourceMap, query),
          map = _getMarkedTree.map,
          tree = _getMarkedTree.tree;
...
/******/ });
//# sourceMappingURL=index.js.map?13ca0173f603e8e9570f